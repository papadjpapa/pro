...
available = uCurrent - uMoney1 - uMoney2 - uMoney3 - uMoney4 ;
newSecond = uCurrent - uMoney1;
newThird =  uCurrent - uMoney1 - uMoney2;
newFourth = uCurrent - uMoney1 - uMoney2 - uMoney3;


if(available > 0){
	available = uCurrent - uMoney1 - uMoney2 - uMoney3 - uMoney4 ;
}else if(available <= 0 && uCurrent>0 && newSecond > 0 && newThird > 0 && newFourth > 0){
	available = 0;
	
	uMoney4 = uCurrent - uMoney1 - uMoney2 - uMoney3;
}else if(available <= 0 && uCurrent>0 && newSecond > 0 && newThird > 0 && newFourth <= 0){
	available = 0;
	uMoney4 = 0;
                    ...
                    <div class="box">
                        ...
                        <div class="plan-selection">
                         ...
                         <div class="plan-selection">
                            <div class="plan-data">
                                <!-- <input id="question2" name="question" type="radio" class="with-font" value="sel" /> -->
                                <label for="question2"><%=uHangmok4 %></label>
                                <p class="plan-text">
                                   comment!</p>
                                <span class="plan-price"><%=uMoney4 %></span>
                            </div>
                        </div>
                        <div class="plan-selection">
                            <div class="plan-data">
