  ...
  <div class="container">
    ...
    <div id="navbar" class="navbar-collapse collapse">
      <ul class="nav navbar-nav">
        ...
        <li><a href="<%=request.getContextPath()%>/list/list.jsp">insert</a></li>
...
<div class="container" role="main">
  ...
  <img src="http://i.imgur.com/7aeXHRa.png?1" class="img-thumbnail" alt="A generic square placeholder image with a white border around it, making it resemble a photograph taken with an old instant camera">
  ...
  <div class="well">
    ...
    <hr>
    <p><a href="http://validator.w3.org/check?uri=http%3A%2F%2Fbootsnipp.com%2Fiframe%2FeNj6B" target="_blank"><small>HTML</small><sup>5</sup></a></p>  
