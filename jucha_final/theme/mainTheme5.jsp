...
<link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/css/mainTheme5CSS.css" />
        ...
        <nav class="navbar navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<%=request.getContextPath()%>/mainTheme5.jsp">SmartSystem</a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="#" class="">list</a></li>
                        <li class="active"><a href="#" class="">insert</a></li>
                        <li class="active"><a href="#" class="">now</a></li>
