...
pstmt=conn.prepareStatement("SELECT A.code_num,C.NAME,A.A_car_num1,A.A_location1,A.A_car_num2,A.A_location2,A.A_car_num3,A.A_location3,A.A_car_num4,A.A_location4, B.B_car_num1,B.B_location1,B.B_car_num2,B.B_location2,B.B_car_num3,B.B_location3,B.B_car_num4,B.B_location4 from a_section as A inner join b_section as B on A.code_num=B.code_num inner join car_list AS C ON C.code_num=B.code_num where A.code_num=?");
